...
Route::middleware(['auth.api','throttle:api'])->group(function () {
    ...
    Route::middleware('role:client')->group(function () { Route::get('/favorites', [TechnicianDiscoveryController::class, 'favorites']); Route::post('/technicians/{technician}/favorite', [TechnicianDiscoveryController::class, 'favorite']); Route::delete('/technicians/{technician}/favorite', [TechnicianDiscoveryController::class, 'unfavorite']); });
